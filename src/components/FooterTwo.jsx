                ...
                <div className="footer-item-two-wrapper d-flex align-items-start flex-wrap">
                    <div className="footer-item max-w-275">
                        <div className="footer-item__logo">
                            <Link to="/">
                                {" "}
                                <img src="https://react.marketpro.wowtheme7.com/assets/images/logo/logo-two-black.png" alt="" />
                            </Link>
                        </div>
                        <p className="mb-24">
                    ...
                    <div className="footer-item">
                        ...
                        <div className="flex-align gap-8 my-32">
                            <Link to="/https://www.apple.com/store" className="">
                                <img src="https://react.marketpro.wowtheme7.com/assets/images/thumbs/store-img1.png" alt="" />
                            </Link>
                            <Link to="/https://play.google.com/store/apps?hl=en" className="">
                                <img src="https://react.marketpro.wowtheme7.com/assets/images/thumbs/store-img2.png" alt="" />
                            </Link>
                        </div>
