                        ...
                        <div className="banner-item-two__slider">
                            <Slider {...settings}>
                                {data?.banners.map((item, i) => (
                                    <div key={i} className="banner-item-two">
                                        <div className="banner-item-two__content">
                                            <span className="text-white mb-8 h6">{item.short_description}</span>
                                        ...
                                        <div className="banner-item-two__thumb position-absolute bottom-0">
                                            <img src={`http://127.0.0.1:8000/` + item.extra_large_image} alt="" />
                                        </div>
                                    </div>
                                ))}
