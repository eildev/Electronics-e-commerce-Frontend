            ...
            <div className="container container-lg">
                <div className="day-sale-box rounded-16 overflow-hidden flex-between position-relative mb-24 z-1">
                    ...
                    <div className="d-xl-block d-none">
                        <img src="https://react.marketpro.wowtheme7.com/assets/images/thumbs/day-sale-img1.png" alt="" />
                    </div>
                    ...
                    <div className="d-md-block d-none pe-xxl-5 pe-md-4">
                        <img src="https://react.marketpro.wowtheme7.com/assets/images/thumbs/day-sale-img2.png" alt="" />
                    </div>
                </div>
            </div>
        </section>
